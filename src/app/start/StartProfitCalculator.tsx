    ...
    return (
        <div>
            <div className="grid border-b border-neutral-800 lg:grid-cols-[0.95fr_1.05fr]">
                <div className="flex items-center gap-4 bg-black px-5 py-4 text-white md:px-8">
                    <span className="text-3xl font-black leading-none text-lime-300">04</span>
                    <div>
                        <p className="text-[10px] font-bold uppercase tracking-[0.16em] text-neutral-500">Payout completes the loop</p>
                        <p className="mt-1 text-sm font-bold">See what the final step can mean for a drop.</p>
                    </div>
                </div>
                <div className="flex items-center justify-between gap-4 bg-lime-300 px-5 py-4 text-black md:px-8">
                    <p className="text-sm font-black uppercase">Put the payout into numbers</p>
