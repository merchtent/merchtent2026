...
export const serverEnv = {
    ...
    stripeAmplifyPriceId: () => optionalEnv("STRIPE_AMPLIFY_PRICE_ID"),
    amplifyMonthlyPriceCents: () => optionalIntegerEnv("AMPLIFY_MONTHLY_PRICE_CENTS"),
    amplifyExtraEarningsCents: () => optionalIntegerEnv("AMPLIFY_EXTRA_EARNINGS_CENTS"),
    amplifyExtraEarningsBasisPoints: () => optionalIntegerEnv("AMPLIFY_EXTRA_EARNINGS_BASIS_POINTS"),
    amplifyMonthlyPromotionCredits: () => optionalIntegerEnv("AMPLIFY_MONTHLY_PROMOTION_CREDITS"),
    amplifyEarningsMode: () => optionalEnv("AMPLIFY_EARNINGS_MODE"),
