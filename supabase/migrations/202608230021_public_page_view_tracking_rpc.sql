...
revoke all on function public.public_track_page_view(text, text, text, text, uuid) from public;
grant execute on function public.public_track_page_view(text, text, text, text, uuid) to anon, authenticated;
