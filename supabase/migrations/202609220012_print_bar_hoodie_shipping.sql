-- Printify blueprint 77 / provider 34 (The Print Bar) shipping supplied on
-- 2026-09-22. AU is the currently supported checkout destination; retain the
-- other displayed zones as source data until international checkout is enabled.
    ...
    jsonb_build_object(
        ...
        'supplied_rates', jsonb_build_array(
            jsonb_build_object(
                ...
                'first_item_cents', 1501,
                'additional_item_cents', 287,
                'currency', 'AUD'
            ),
            jsonb_build_object(
